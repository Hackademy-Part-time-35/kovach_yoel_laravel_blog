...
<body>
    {{-- <li>
        <a href="/blog/resources/articoli.php">articoli</a>
    </li>
    <li>
        <a href="/blog/resources/chiSiamo.php">chiSiamo</a>
    </li>
    <li>
        <a href="/blog/resources/contatti.php">contatti</a>
    </li>
    <li>
        <a href="/blog/resources/welcome.blade.php">welcome.blade</a>
    </li> --}}
...
>
    <div class="md:flex md:items-center md:justify-between md:gap-2">
        <div>
            ...
            <div class="mt-4 text-lg font-semibold text-gray-900 dark:text-white lg:text-2xl">Database file at path [C:\Users\yoelk\programacion\hackademy\laravel\1\blog\database\database.sqlite] does not exist. Ensure this is an absolute path to the database. (Connection: sqlite, SQL: select * from &quot;sessions&quot; where &quot;id&quot; = 8JbSdGq5LLIgsYlqnffMZw435y6ENOSybYWD1pGh limit 1)</div>
        </div>
        ...
        <div class="hidden text-right md:block md:min-w-64">
            ...
            <div class="mt-4 px-4">
                <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.3.7 — Laravel 11.10.0</span>
            </div>
        </div>
    </div>
</section>
